class QrCodeAtomique extends QRCode{
    ...
    */
    ...
    /*
    * Modifie le nom de la famille à laquelle appartient ce QRCode Atomique
    */
    setNomFamille(nom){
    ...
    */
    ...
    /*
    * Change l'ordre du QRCode dans sa famille
    */
    setOrdre(){
    ...
    /*
    * Renvoie les données contenues dans le QRCode Atomique
    */
    getDonnees(){
